...
def update_candles(
    ...
    of candles in the state is less than the max number of candles we want to keep,
    ...
    # If the total number of candles in the state is greater than the max number
    # of candles we want to keep,
    # we remove the oldest candle from the list.
...
def same_window(candle_1: dict, candle_2: dict) -> bool:
    """
    Checks if candle_1 and candle_2 are in the same window.
    Args:
        candle_1: The current candle
        candle_2: The last candle in the list
    Returns:
        True if candle_1 and candle_2 are in the same window, False otherwise
    """
    return (
